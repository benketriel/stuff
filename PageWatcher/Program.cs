...
namespace PageWatcher
{
    class Program
    {
        ...
        private static readonly int TEST_INTERVAL_SECS = 10;
                ...
                try
                {
                    using (var client = new WebClient())
                    {
                        ...
                        if (lastRefs.Count != refs.Count() || refs.Any(r => !lastRefs.Contains(r)))
                        {
                            ...
                            var body = "De senaste 10 sekunderna har minst en ny lägenhet kommit som du inte har fått notis om förut:<br/>";
